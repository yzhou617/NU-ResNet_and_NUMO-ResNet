...
def bulid_model_Mathews_train_data(real_RNA_loc):
...
def entrna_main_Mathews_train_data(seq,sec_str,real_RNA_loc = "matthews_MFENFE2_training_data_ENTRNA_features.csv"):
    df_pred = extract_features.extract_features_pseudoknot_free(seq,sec_str)
    scaler, clf, train_acc = bulid_model_Mathews_train_data(real_RNA_loc)
