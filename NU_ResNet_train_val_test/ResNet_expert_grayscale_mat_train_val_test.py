...
model_name_utilized = 'NU_ResNet_18_color_mat_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
...
figure_name_utilized = 'NU_ResNet_18_color_mat_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
    '_weightd_'+str(weight_decay_value_utilized)+'_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+\
