...
from train_val_test_plot_functions import create_weighted_sampler, dataloader_prep_with_sampler, dataloader_prep, train_val_ResNet_expert, test_ResNet_expert
...
for k, index_train_val_test_data in enumerate(k_fold_index_train_val_test_data):
    ...
    model_name_utilized = 'Fold_'+str(fold_num)+'_NUMO_ResNet_18_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
    ...
    train_val_record_file_name = 'Fold_'+str(fold_num)+'_NUMOResNet_train_val_record_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
        '_weightd_'+str(weight_decay_value_utilized)+'_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+\
    ...
    saved_models_metrics_file_name = 'Fold_'+str(fold_num)+'_NUMOResNet_saved_models_metrics_batch_'+str(batch_size_value_utilized)+'_lr_'+str(learning_rate_value_utilized)+\
        '_weightd_'+str(weight_decay_value_utilized)+'_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+\
            str(gamma_value_utilized)+'RNAFold_data.csv'
...
best_val_acc_model_k_fold_cv_file_name = 'best_val_acc_model_k_fold_cv_batch_NUMOResNet_'+str(batch_size_value_utilized)+\
...
best_val_loss_model_k_fold_cv_file_name = 'best_val_loss_model_k_fold_cv_batch_NUMOResNet_'+str(batch_size_value_utilized)+\
      '_lr_'+str(learning_rate_value_utilized)+'_weightd_'+str(weight_decay_value_utilized)+\
            '_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+str(gamma_value_utilized)+'RNAFold_data.csv'
...
model_from_last_epoch_k_fold_cv_file_name = 'model_from_last_epoch_k_fold_cv_batch_NUMOResNet_'+str(batch_size_value_utilized)+\
      '_lr_'+str(learning_rate_value_utilized)+'_weightd_'+str(weight_decay_value_utilized)+\
            '_epochs_'+str(num_epochs_utilized)+'_scheduler_gamma_'+str(gamma_value_utilized)+'RNAFold_data.csv'
